...
dao_proxy=$( cat conf.json | JSON.sh -p | egrep '\["dao_proxy"*"\]' | sed -e 's/\[\"dao_proxy\"\]//g')
docker run -d --name openidao_proxy                                                           --net=container:openicb  openiicteu/cloudlet_platform 	-w dao_proxy            -c '$dao_proxy'
sleep 4

dao=$( cat conf.json | JSON.sh -p | egrep '\["dao"*"\]' | sed -e 's/\[\"dao\"\]//g')
...
swagger_def_https=$( cat conf.json | JSON.sh -p | egrep '\["swagger_def_https"*"\]' | sed -e 's/\[\"swagger_def_https\"\]//g')
...
swagger_def_http=$( cat conf.json | JSON.sh -p | egrep '\["swagger_def_http"*"\]' | sed -e 's/\[\"swagger_def_http\"\]//g')
...
type_api=$( cat conf.json | JSON.sh -p | egrep '\["type_api"*"\]' | sed -e 's/\[\"type_api\"\]//g')
...
object_api=$( cat conf.json | JSON.sh -p | egrep '\["object_api"*"\]' | sed -e 's/\[\"object_api\"\]//g')
...
cloudlet_api=$( cat conf.json | JSON.sh -p | egrep '\["cloudlet_api"*"\]' | sed -e 's/\[\"cloudlet_api\"\]//g')
...
attachments_api=$( cat conf.json | JSON.sh -p | egrep '\["attachments_api"*"\]' | sed -e 's/\[\"attachments_api\"\]//g')
...
search_api=$( cat conf.json | JSON.sh -p | egrep '\["search_api"*"\]' | sed -e 's/\[\"search_api\"\]//g')
...
permissions_api=$( cat conf.json | JSON.sh -p | egrep '\["permissions_api"*"\]' | sed -e 's/\[\"permissions_api\"\]//g')
...
notifications=$( cat conf.json | JSON.sh -p | egrep '\["notifications"*"\]' | sed -e 's/\[\"notifications\"\]//g')
...
auth_api=$( cat conf.json | JSON.sh -p | egrep '\["auth_api"*"\]' | sed -e 's/\[\"auth_api\"\]//g')
...
crud_api=$( cat conf.json | JSON.sh -p | egrep '\["crud_api"*"\]' | sed -e 's/\[\"crud_api\"\]//g')
...
openi_rrd=$( cat conf.json | JSON.sh -p | egrep '\["openi_rrd"*"\]' | sed -e 's/\[\"openi_rrd\"\]//g')
...
https_redirect=$( cat conf.json | JSON.sh -p | egrep '\["https_redirect"*"\]' | sed -e 's/\[\"https_redirect\"\]//g')
...
openi_aggregator=$( cat conf.json | JSON.sh -p | egrep '\["openi_aggregator"*"\]' | sed -e 's/\[\"openi_aggregator\"\]//g')
