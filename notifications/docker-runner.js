...
var notif_broadcaster_addr = 'tcp://'+os.networkInterfaces().eth0[0].address+':49501'; // Points to something?

var m_handler_sink_addr = 'tcp://'+os.networkInterfaces().eth0[0].address+':49504'; // Points to mongrel2
var m_handler_source_addr = 'tcp://'+os.networkInterfaces().eth0[0].address+':49503';
var m_handler_sub_source_addr = 'tcp://'+os.networkInterfaces().eth0[0].address+':49505';
var m_handler_sub_sink_addr = 'tcp://'+os.networkInterfaces().eth0[0].address+':49506'; // Points to mongrel2

var comms_sink_addr = 'tcp://'+os.networkInterfaces().eth0[0].address+':49998'; // No idea
